...
// // import DigitallyEnabled from 'scfonext/pages/components/leadPages/digitallyEnabled';
// // import PartnerLogos from 'scfonext/pages/components/leadPages/partnerLogos';
...
// 	// 		<>
// 	// 			<Meta title="Virtual CFO for startups and SMEs" description="You run your business. We will do the bookkeeping. India's first Virtual CFO Service for start-ups and SMEs."></Meta>
...
// 	// 																		<Col>
// 	// 																			<h4 className="color__dark">Get free consultation</h4>
...
// 	// 																			<Form.Group controlId="formMobile">
// 	// 																				<Form.Control type="tel" placeholder="Mobile Number *" required name="mobile" value={fields.mobile} onChange={() => { }} min="10" max="10" length="10" />
