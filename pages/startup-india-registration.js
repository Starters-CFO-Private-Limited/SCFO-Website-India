...
// import Perks from 'scfonext/pages/components/leadPages/perks';
...
export default class StartupIndiaRegistration extends React.Component {
    render() {
        return (
            <>404</>
        )
